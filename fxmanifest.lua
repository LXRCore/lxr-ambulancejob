...
description 'LXRCore v3 doctor: death and bleed-out, revives and treatment with catalog medicine, office beds, duty; dispatch hears every fall'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-doctor'
